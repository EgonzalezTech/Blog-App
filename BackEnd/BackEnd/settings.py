...
SECRET_KEY = 'django-insecure-cv966&b0e_kix40^lsdc#jjh@0@0!#(!7u(od4=&0=o_@rb-&t'
...
DATABASES = {
    'default': {
        ...
        'USER': 'egonzalez',  # User PostgreSQL
        'PASSWORD': 'omega',
        'HOST': 'localhost',  #
        'PORT': '5432',  #
    }
...
JAZZMIN_SETTINGS = {
    "site_title": "Blog_Edwin",
    "site_header": "Blog Edwin",
    "site_brand": "Modern Marketplace ",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "images/logos/logo.jpg",
    "welcome_sign": "Welcome To Edwin",
    "copyright": "Edwin Gonzalez",
